    ...
    return (
        <div className={[props.popupOpen ? "popup popup_opened" : "popup", `popup_${props.popupType}`].join(' ')}>
            <div className={["popup__container", `popup__container_${props.popupType}`].join(' ')}>
                ...
                <form className={["popup__form", `popup__form_${props.popupType}`].join(' ')}
                      name={props.popupFormName}>
                    {props.children}
                    <button className={["popup__submit", `popup__submit_${props.popupType}`].join(' ')} type="submit"
                            data-value={props.submitButtonText}>{props.submitButtonText}</button>
                </form>
            </div>
        </div>
    )
